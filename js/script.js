...
const pageMain = {
    data : ()=> {
        return {
            ...
            randomIndex : Math.floor(Math.random() * 5) //0~4
        }
    },
    ...
    data :  ()=> {
        return {
            item : [
                ...
                ["animal_news_2.jpg", "animal_news_3"],
    ...
    data :  ()=> {
        return {
            item : [
                ...
                ["history_news_2.jpg", "history_news_3"],
    ...
    data :  ()=> {
        return {
            item : [
                ...
                ["environ_news_2.jpg", "environment_news_3"],
    ...
    data :  ()=> {
        return {
            item : [
                ...
                ["science_news_2.jpg", "science_news_3"],
    ...
    data :  ()=> {
        return {
            item : [
                ...
                ["travel_news_2.jpg", "travel_news_3"],
